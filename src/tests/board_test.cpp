...
TEST_F(BoardTest, VerifyFENFunctionality) {
  ...
  BoardImpl<Variant::SUICIDE> board(expected_fen);
...
TEST_F(BoardTest, VerifyPieceMovements) {
  ...
  BoardImpl<Variant::SUICIDE> board(init_board);
...
TEST_F(BoardTest, VerifyNumPieces) {
  BoardImpl<Variant::SUICIDE> board("8/8/1r1q4/2P5/8/8/8/8 w - -");
...
TEST_F(BoardTest, Pawn2SpaceMoves) {
  BoardImpl<Variant::SUICIDE> board("8/3p/8/8/8/8/1P6/8 w - -");
...
TEST_F(BoardTest, EnpassantCapture) {
  BoardImpl<Variant::SUICIDE> board("8/8/8/8/2p5/8/1P6/8 w - -");
  EXPECT_TRUE(board.EnpassantTarget() == -1);
  board.MakeMove(Move("b2b4"));
  EXPECT_TRUE(board.EnpassantTarget() != -1);
...
TEST_F(BoardTest, Zobrist2) {
  BoardImpl<Variant::SUICIDE> board("8/1p6/8/8/8/8/1P6/8 w - -");
  board.MakeMove(Move("b2b4"));
  U64 z1 = board.ZobristKey();
  string b1 = board.ParseIntoFEN();
  ...
  board = BoardImpl<Variant::SUICIDE>("8/1p6/8/8/8/1P6/8/8 w - -");
...
TEST_F(BoardTest, CastlingTest) {
  ...
  BoardImpl<Variant::NORMAL> board(init_board);
  board.MakeMove(Move("e2e4"));
  board.MakeMove(Move("e7e5"));
...
TEST_F(BoardTest, PawnPromotions) {
  BoardImpl<Variant::SUICIDE> board("8/8/8/P7/8/2p5/3ppp2/8 b - -");
...
TEST_F(BoardTest, SANTest2) {
  BoardImpl<Variant::NORMAL> board("8/2k5/4r3/3P2N1/8/R7/7p/3R2N1 w - -");
...
TEST_F(BoardTest, SANTest3) {
  BoardImpl<Variant::NORMAL> board("8/2k5/4r3/3P2N1/8/R7/7p/3R2N1 b - -");
